...
default_define('COMPETITION_START',	"2016-04-30 00:00:00");
default_define('COMPETITION_END',	"2016-05-01 23:00:00");
...
default_define('TEAM_STATUS_DIR', 	ROOT_DIR . '/dev-content/team-status');
